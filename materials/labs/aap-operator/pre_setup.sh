...
pip install GitPython==3.1.43 gitdb==4.0.11 python-gitlab==4.2.0 requests-toolbelt==1.0.0 rht-labs-core rht-labs-ocpcli rht-labs-do380==4.14.0.dev267 smmap==5.0.1
